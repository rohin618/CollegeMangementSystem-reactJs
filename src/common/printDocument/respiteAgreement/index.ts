...
import { getActiveFundBlockBed, getActiveFundDetails, getActiveRespiteDetails, getActiveWeekInfoByEndDate, getLabelByValue, priceFormat } from '../../../helpers/helpers'
...
import { getActiveFundDetailsByJointFund, getActiveFundDetailsByLAOrICB } from '../../../helpers/resident';



export const respiteAgreementDocument = (residentData: any,
    comapanyDetails: any,
    roomInfo: any,
    theme: any,
...
>
            ...
            <header class="mb-5 header-contract">
                <div class="text-center">
                    ...
                    <p class="small-muted" style="color:${theme.muted};font-size:.92rem">(Terms and Conditions for Residence)
                    </p>
                </div>
            ...
            <!-- section A -->
            <section class="" id="section-a" style="break-before: page; page-break-before: always; margin-top: 60px;">
                <h4
  class="section-title"
  style="
...
>
                    ...
                    Section A </h4>
                <h4 style="margin-top:2rem;margin-bottom:1rem">ABOUT ${comapanyDetails?.tradeName?.toUpperCase() || ''}</h4>
                <p class="clause" style="margin-bottom:1rem">${comapanyDetails?.tradeName} (the "Home")  is owned and operated by ${comapanyDetails?.name} (the "Company"). The
                    ...
                    importance. Residents are involved as much as possible in making decisions about the way the Home
                    (their home) is run. The Company’s reputation depends on ensuring that we provide the quality of
                    service and care that our residents and their families require.</p>
                <h4 style="margin-top:2rem;margin-bottom:1rem">ABOUT THIS DOCUMENT</h4>
                ...
                <h4 style="margin-top:2rem;margin-bottom:1rem">IMPORTANT INFORMATION FOR REPRESENTATIVES OF RESIDENTS
                </h4>
                ...
                <p style="margin:0;">If you are the resident’s validly appointed attorney or
...
>
                    ...
                    Section B </h4>
                <h4 style="margin-top:2rem;margin-bottom:1rem">OUR CHARGES</h4>
                    ...
                    <li class="pt-3">
                        ...
                        <ul style="list-style: none; padding-left: 0;">
                            <li class="pt-3 d-flex">
                                ...
                                <b>Room ${isPrivate ? residentData?.bedDetails?.bedName : 'NA'}</b> at <b>${isPrivate ? comapanyDetails?.tradeName : "NA"}</b> has been reserved for <b>${getLabelByValue(SALUTATION_LIST, residentData?.personal.salutation)}. ${isPrivate ? residentData?.personal.name : 'NA'}.</b> The weekly
                                nursing fee is <b>${isPrivate ? priceFormat(roomInfo?.perWeek) : 'NA'}</b> excluding the FNC from <b>
                                   ${isPrivate ? moment(residentData?.admission.admissionDate).format('DD/MM/YYYY') : "NA"}</b> for the 
                                period <b>${isPrivate ? moment(start).format('DD/MM/YYYY') : "NA"} </b> to <b>${isPrivate ? moment(end).format('DD/MM/YYYY') : "NA"} </b> and the
                                Respite fee is
                                <b>${isPrivate ? priceFormat(totalAmount) : "NA"} –  (${isPrivate ? noOfRespiteWeeks : "NA"} weeks)</b>
                                </span>
                            </li>
                            <li class="pt-3 d-flex">
                                    <span class="list-number"><b>1.2</b></span>
                                    <span class="list-text">
                                The charge that applies to you as a resident of the Home depends on your assessed
                            ...
                            <li class="pt-3 d-flex">
                                ...
                                <span class="list-text">
                                If your care needs change so that you become eligible for continuing NHS
                                During any period that there is a shortfall in your fees it may be necessary for
                                you to move to a less expensive room.
                                </span>
                            </li>
                            <li class="pt-3 d-flex">
                                <span class="list-number"><b>1.5</b></span>
                                <span class="list-text">
                                The appointeeship/POA/LPA needs to be informed in writing to us immediately. This
                                contract will be deemed not valid from the date we are informed, and new contract will
                    ...
                    <li class="pt-3">
                        ...
                        <ul style="list-style: none;">
                            <li class="mt-3 d-flex">
                                ...
                                <span class="list-text">
                            <b>Room ${isCHC ? residentData?.bedDetails?.bedName : 'NA'}</b> at <b>${isCHC ? comapanyDetails?.tradeName : "NA"}</b> has been reserved for <b>${getLabelByValue(SALUTATION_LIST, residentData?.personal.salutation)}. ${isCHC ? residentData?.personal.name : 'NA'}.</b>

                                The weekly nursing fee paid by the ${fundingNameIcb ? fundingNameIcb : 'NHS'} is 
                                <b>
                                    ${isCHC ? priceFormat(
        +fundDetails?.familyTopupStatus === FAMILY_OR_THIRD_PARTY_TOPUP_STATUS.YES
            ? (roomPrice || 0) - (fundDetails?.familyTopupPrice || 0)
            : (roomPrice || 0)
    ) : isJointFund ? priceFormat(jointFundIcbPrice) : "NA"}
                                </b> 
                                ...
                                <span class="list-text">
                                 ...
                                 The family contributes <b>${isCHC ? +fundDetails?.familyTopupStatus === FAMILY_OR_THIRD_PARTY_TOPUP_STATUS.YES ? priceFormat(fundDetails?.familyTopupPrice || 0) : "NA" : "NA"}</b> for a larger, 
                                 enhanced room with additional features, which they prefer over a standard CHC-funded room. The Respite family Top-up contribution is <b>${isCHC ? priceFormat(fundDetails?.familyTopupPrice * totalDays) : 'NA'}</b>
                                 for the period 
                                <b>
                                    ${(isCHC && +fundDetails?.familyTopupStatus === FAMILY_OR_THIRD_PARTY_TOPUP_STATUS.YES) ? moment(start).format('DD/MM/YYYY') : "NA"}
                                </b> 
                                to 
                                <b>
                                    ${(isCHC && +fundDetails?.familyTopupStatus === FAMILY_OR_THIRD_PARTY_TOPUP_STATUS.YES) ? moment(end).format('DD/MM/YYYY') : "NA"}
                                    – 
                                    (${isCHC ? noOfRespiteWeeks : "NA"} Weeks)
                                </b>
                                </span>
                            </li>
                            ...
                            <li     class="pt-3 d-flex">
                                ...
                                <ul style="list-style: none;">
                                    <li class="pt-3 d-flex">
                                        ...
                                        one month’s
                                        notice and you will have to leave the Home at the end of the notice period;
                                        </span>
                                    </li>
                                    <li class="pt-3 d-flex">
                    ...
                    <li class="pt-3">
                        ...
                        <ul style="list-style: none;">
                            ...
                            <span class="list-text"> 
                            <b>Room ${(isLocalAuthority || isJointFund) ? residentData?.bedDetails?.bedName : 'NA'}</b> at <b>${(isLocalAuthority || isJointFund) ? comapanyDetails?.tradeName : "NA"}</b> has been reserved for <b>${getLabelByValue(SALUTATION_LIST, residentData?.personal.salutation)}. ${(isLocalAuthority || isJointFund) ? residentData?.personal.name : 'NA'}.</b>
                            The weekly nursing fee is <b>${(isLocalAuthority || isJointFund) ? priceFormat(roomPrice) : "NA"}</b> from <b>

                                ${(isLocalAuthority || isJointFund) ? moment(fundDetails?.sDate).format('DD/MM/YYYY') : "NA"} </b>excluding FNC.
                                
                                The weekly ${isFamilyTopUp ? 'Family Topup' : 'Client Contribution'}  is

                                <b>${isFamilyTopUp ? priceFormat(fundDetails?.familyTopupPrice || 0) : priceFormat(fundDetails?.clientContribution || 0)},</b> weekly Third-Party
                                Top-Up is <b>${(isLocalAuthority || isJointFund) ? priceFormat(fundDetails?.thirdPartyTopupPrice || 0) : 'NA'},</b>
                                and the weekly Local Council Contribution is <b>
                                ${(isLocalAuthority || isJointFund)
            ? priceFormat(
                (isJointFund
            ...
            : 'NA'}
                                                                ...
                                                                The Respite ${isFamilyTopUp ? 'Family Topup' : 'Client Contribution'} fee is <b>${(isLocalAuthority || isJointFund)
            ? isFamilyTopUp ? priceFormat(totalDays * fundDetails?.familyTopupPrice) : priceFormat(totalDays * fundDetails?.clientContribution)
            : '£0.00'
        }</b>
                                 for the period <b>${(isLocalAuthority || isJointFund) ? moment(start).format('DD/MM/YYYY') : 'NA'}</b> to <b>${(isLocalAuthority || isJointFund) ? moment(end).format('DD/MM/YYYY') : 'NA'} 
                                    –  (${(isLocalAuthority || isJointFund) ? noOfRespiteWeeks : 'NA'}weeks)</b> 
                                </span>
                                </li>
                            <li class="pt-3 d-flex">
                            ...
                            <li  class="marginTop-space-doc" style="break-before: page; page-break-before: always;">
                                ...
                                <span class="list-text">The local authority’s assessment of the amount of its contribution towards our
                            ...
                            <li class="pt-3 d-flex">
                                ...
                                <span class="list-text">If you have been assessed by the local authority to pay a Client Contribution,
                            ...
                            <li >
                                ...
                                you pay the
                                deposit for the room and don’t take the room, you will lose the full deposit.</span>
                                </div>
                            </li>
                        </ul>
                    </li>
                    <li class="pt-3">
                        ...
                        <ul style="list-style: none;">
                            ...
                            <li class="pt-3 d-flex">
                                ...
                                <span class="list-text">
                               At the end of your stay we will provide a statement of account. If this shows that there has been an overpayment of any charges, the amount of the overpayment will be refunded. Alternatively, if the statement shows an outstanding amount due to the Home in respect of any charges, the outstanding amount will be payable.
                                </span>
                            </li>
                            <li class="pt-3 d-flex">
                                ...
                                representative to ensure Head Office received their letter.
                                </span>
                            </li>
                        </ul>
                    </li>
                    <li class="pt-3 marginTop-space-doc" style="break-before: page; page-break-before: always;">
                        ...
                        <ul style="list-style: none;">
                            ...
                            <li class="pt-3 d-flex">
                                ...
                                <span class="list-text">
                                The weekly amount that the NHS will pay is fixed according to whether your 
                    ...
                    <li class="pt-3" >
                        ...
                        <ul style="list-style: none;">
                            ...
                            <li class="pt-3 d-flex">
                                ...
                                <span class="list-text">
                                If you have stayed over 4 weeks on respite, we require one month notice (unless
                                notice is given during trial period). Our charges end one month from the date written
                                notice is given or later if the resident moves out at a later date.
                                </span>    
                            </li>
                            <li class="pt-3 d-flex">
            ...
            <!-- Section-C -->
            <section class="mb-4 marginTop-space-doc" id="section-c" class="marginTop-space-doc" style="break-before: page; page-break-before: always;">
                              <h4
  class="text-center"
  style="
    background:${theme.sectionBg};
...
>
                    Section C </h4>
                <h4 style="margin-top:2rem;margin-bottom:1rem">SERVICES COVERED BY OUR CHARGES (no additional payment
                    required)</h4>
                ...
                <ul>
                    ...
                    <li>The opportunity to join in with activities run by the Home and the use of recreational
                        ...
                        excursions).</li>
                    <li>Assistance with washing, bathing, medication and other personal services, as reasonably
                ...
                <h4 style="margin-top:2rem;margin-bottom:1rem">ADDITIONAL THINGS THAT WILL BE CHARGED TO YOU</h4>
                ...
                <h4  class="marginTop-space-doc" style="break-before: page; page-break-before: always;">PERSONAL POSSESSIONS AND PETS</h4>
                ...
                <ul>
                    ...
                    <li>Portable Appliance Testing (PAT) is arranged by the Home each year to satisfy us that
                ...
                <h4 style="margin-top:2rem;margin-bottom:1rem">CHANGE OF ROOM </h4>
                <p class="clause" style="margin-bottom:1rem">Our charges vary according to your care needs and the size
                    ...
                    below).</p>
                <h4 class="marginTop-space-doc" style="break-before: page; page-break-before: always; margin-top:2rem;margin-bottom:1rem">RIGHTS OF RESIDENCY</h4>
                ...
                <h4 style="margin-top:2rem;margin-bottom:1rem">TRIAL PERIOD</h4>
                ...
                <h4 style=" margin-top:2rem; margin-bottom:1rem">WHAT WE ASK OF YOU</h4>
                ...
                <ul>
                    ...
                    <li class="marginTop-space-doc" style="break-before: page; page-break-before: always;"><b>Keeping your medication in the locked cupboard provided</b> – the Home is required to ensure
                        that
                    ...
                    <li><b>The signing of legal documents</b> – the Home’s staff are not permitted to sign as a witness
                        to any
                ...
                <h4 style=" margin-top:2rem;margin-bottom:1rem">CIRCUMSTANCES IN WHICH YOU MAY BE ASKED TO LEAVE</h4>
                <ol>
                    <li>
                    ...
                    <li><b>If you become eligible, and apply, for funding by the local authority and have given us less
                        ...
                        <ol class="marginTop-space-doc" style="break-before: page; page-break-before: always; margin-top: 1rem;margin-bottom:1rem" type="a">
                    ...
                    <li><b>Emergency closure of the Home:</b> In the unlikely event that the Home has to be closed in an
                ...
                <h4 style=" margin-top:2rem;margin-bottom:1rem">SOME GENERAL INFORMATION ABOUT THE HOME</h4>
                ...
                <h4 style="margin-top:2rem;margin-bottom:1rem">DATA PROTECTION</h4>
                ...
                <h4 style="margin-top:2rem;margin-bottom:1rem">CONTRACTS (RIGHTS OF THIRD PARTIES) ACT 1999</h4>
                ...
                <h4 class="marginTop-space-doc" style="break-before: page; page-break-before: always; margin-top: 1rem;margin-bottom:1rem">COMPLAINTS PROCEDURE</h4>
                ...
                <p class="clause" style="margin-bottom:1rem">You may also take your concerns to the Care Quality
                    ...
                    is 0300 061 6161.</p>
                <div class="respiteContract-footer"></div>
                <hr class="mt-5 "/>
                <p class="mb-3 mt-3">
                    <strong>I HAVE READ AND UNDERSTOOD THE CONDITIONS OF ADMISSION AND ACCEPT THEM:</strong>
                </p>
                <p>Client's Name: <span class="sig-line"
                        style="border-bottom:1px solid #000;min-width:260px;display:inline-block;height:1.6rem"></span>
                </p>
                <div class="d-flex flex-wrap justify-content-between">
                    <div>
                        <p class="mb-2">Client's Signature: <span class="sig-line"
                                style="border-bottom:1px solid #000;min-width:260px;display:inline-block;height:1.6rem"></span>
                        </p>
                        <p class="small-muted" style="color:${theme.muted};font-size:.92rem">
(On behalf of the client)</p>
                    </div>
                    <p class="mb-2">Date: <span class="sig-line"
                            style="width:120pxborder-bottom:1px solid #000;min-width:260px;display:inline-block;height:1.6rem"></span>
                    </p>
                </div>
            </section>
        </div>
