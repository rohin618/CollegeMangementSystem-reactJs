...
import { BILLING_PATTERN_STATUS, BOOKING_TYPE, CREDIT_STATUS, CREDIT_TYPE, DOCUMENT_STATUS, DOCUMENT_TYPE, INVOICE_CATEGORY, INVOICE_STATUS, PREBOOK_TYPE, REPORT_TYPE, ROOM_STATUS, FAMILY_OR_THIRD_PARTY_TOPUP_STATUS, VAT_CONFIG_STATUS, VAT_STATUS, BLOCK_BEDS_TYPE, BLOCK_BEDS_STATUS, LA_STATUS, CHART_OF_ACCOUNTS_CATEGORY_TYPE, OPENING_BALANCE_STATUS, CHART_OF_ACCOUNTS_STATUS, OPENING_BALANCE_TYPE, GENDER, FOLLOW_UP_PRIORITY, FOLLOW_UP_STATUS, VENDOR_STATUS, PRODUCT_STATUS, PURCHASE_ORDER_STATUS, VAT_MODE_TYPE, GRN_STATUS_TYPE, MAIL_DRAFT_TYPE, EMAIL_STATUS, NOK_EMAIL_TYPE, DISCOUNT_STATUS, DISCOUNT_TYPE, DISCOUNT_APPLICABLE_TYPE, DEBIT_NOTE_SETTLEMENT_TYPE, DEBIT_NOTE_STATUS } from "../../constant/app";
